...
def plot_hamiltonian_density(density, xlim_q, ylim_q, xlim_p, ylim_p, n=100, q_0=0., q_1=0., name=None):
    ...
    im_q = ax[0].imshow(Z_q, extent=(-xlim_q, xlim_q, -ylim_q, ylim_q), origin='lower', cmap='viridis')
    ax[0].set_title("q")
    ax[0].set_xlabel("q1")
    ax[0].set_ylabel("q2")
    fig.colorbar(im_q, ax=ax[0])
    im_p = ax[1].imshow(Z_p, extent=(-xlim_p, xlim_p, -ylim_p, ylim_p), origin='lower', cmap='viridis')    
    ax[1].set_title("p")
    ax[1].set_xlabel("p1")
    ax[1].set_ylabel("p2")
